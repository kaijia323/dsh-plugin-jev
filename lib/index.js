 ...
 * shape of the official TypeSafe API. The reply text must match the wire
 * exactly, or callers read undefined.
...
function describeTool() {
  return [
    ...
    'the yes/no primitive is { type: "noul", instructions: "yes/no question" } or the equivalent { type: "boolean", ... }: either spelling is accepted, and boolean is normalized to noul on the wire.',
